...
export const Canvas = ({ boardId }: CanvasProps) => {
    ...
    }, [canvasState.mode, duplicateLayers]);
    
    const handleMoveSelectedLayers = useCallback((offset: Point) => {
        ...
        function onKeyDown(e: KeyboardEvent) {
            ...
            switch (e.key) {
                ...
                case "ArrowUp":
                    ...
                    handleMoveSelectedLayers(offset);
                    break;
                case "ArrowDown":
                    offset = { x: 0, y: MOVE_OFFSET };
                    handleMoveSelectedLayers(offset);
    ...
    }, [handleDuplicateLayers, handleMoveSelectedLayers, handleUndoRedo]);
